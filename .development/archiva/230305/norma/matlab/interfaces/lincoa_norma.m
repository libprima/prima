...
%
% Remarks:
% !!! TREAT probinfo AS A READONLY VARIABLE AFTER PREprima_norma !!!
% !!! DO NOT CHANGE probinfo AFTER PREprima_norma !!!
%
% TODO: None
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% PROBINFO in prima_norma; that said, in such a senario, the PROBINFO of this solver
