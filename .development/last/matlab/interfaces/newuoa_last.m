function [x, fx, exitflag, output] = newuoa_last(varargin)
...
%
%   [x, fx, exitflag, output] = newuoa_last(INPUTS)
%
...
%       solver: backend solver that does the computation, i.e., 'newuoa_last'
