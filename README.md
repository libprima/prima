...
package providing a C version of the **old Fortran 77 implementation** of COBYLA, NEWUOA, and
BOBYQA. Such C code is translated from the Fortran 77 code straightforwardly, if not automatically
by [f2c](https://netlib.org/f2c/f2c.pdf), and hence inherits the style, structure, and probably
bugs of the old Fortran 77 implementation.
