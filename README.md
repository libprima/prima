...
based on an earlier version of the **modern** Fortran implementation. The translation from the
**modern** Fortran code to the MATLAB code is quite straightforward and **can be automated**.
