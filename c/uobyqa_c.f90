...
subroutine uobyqa_c(cobj_ptr, n, x, f, nf, rhobeg, rhoend, maxfun, iprint, info) bind(C)
...
call uobyqa(calfun, x_loc, f_loc, nf=nf_loc, rhobeg=rhobeg_loc, rhoend=rhoend_loc, &
