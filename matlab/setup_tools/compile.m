...
if contains(compiler_manufacturer, 'gnu')  % gfortran
    ...
    % -ftrampoline-impl=heap instructs the compiler to put the trampolines on the heap instead of
    % the stack. This option is available since gfortran 14. Without this option, exeuctable stacks
    % will be generated by the internal subroutines passed as actual arguments. For details, see
