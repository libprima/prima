% MNEWUOA provides the MATLAB implementation of M. J. D. Powell's NEWUOA algorithm described in
%
...
function [x, f, exitflag, nf, xhist, fhist] = mnewuoa(calfun, x, rhobeg, rhoend, eta1, eta2, gamma1, gamma2, ftarget, maxfun, npt, iprint, maxhist, output_xhist, debugflag)
	...
	[x, nf, f, fhist, xhist, exitflag] = newuoa_mat.newuob(calfun, iprint, maxfun, npt, eta1, eta2, ftarget, gamma1, gamma2, rhobeg, rhoend, x, maxfhist, maxxhist, debugflag);
	%--------------------------------------------------------------------------------------------------%
