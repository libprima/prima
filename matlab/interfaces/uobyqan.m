function [x, fx, exitflag, output] = uobyqan(varargin)
...
%
%   [x, fx, exitflag, output] = uobyqan(INPUTS)
%
...
%       solver: backend solver that does the computation, i.e., 'uobyqan'
