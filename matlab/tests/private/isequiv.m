...
if ~isempty(requirements.list)
    ...
    case {'lincoa', 'lincoan'}
        ...
        blacklist = [blacklist, {'QPNBOEI2', 'QPCBOEI2', 'SPANHYD', 'SPANHYD', 'SPANHYD', 'MINSURF'}]; % Too long to solve
    ...
    case {'cobyla', 'cobylan'}
        ...
        blacklist = [blacklist, {'PRODPL0', 'DEGENLPB', 'ANTWERP', 'SIPOW3', 'AVION2', 'HIMMELBI', 'HS55','PRODPL1', 'BQPGASIM', 'POLAK2', 'LOADBAL'}]; % Takes long to solve
