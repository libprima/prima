...
if ~isempty(requirements.list)
    ...
    case {'cobyla', 'cobylan'}
        ...
        blacklist = [blacklist, {'PRODPL0', 'DEGENLPB', 'ANTWERP', 'SIPOW3', 'AVION2', 'HIMMELBI', 'HS55','PRODPL1', 'BQPGASIM', 'POLAK2', 'LOADBAL','MIFFLIN1', 'ACOPR14', 'PALMER1NE'}]; % Takes long to solve
