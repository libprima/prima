...
case 'cobyla'
    ...
    % the problem is the time in seconds. All the linear and nonlinearly constrained problems with
    % at most 100 variables and 10000 constraints were tested. Bound-constrained or unconstrained
    ...
    blacklist = [blacklist, { ...
        ...
        'CHEBYQADNE', ...   % 546
        'LUKSAN13', ...     % 508
        %'HAIFAM', ...       % 173, included in the first list
        %'HIMMELBI', ...     % 100, included in the first list
        %'VANDERM3', ...     % 76, included in the first list
        %'AIRPORT', ...      % 73, included in the first list
        %'DUAL1', ...        % 73, included in the first list
        %'VANDERM1', ...     % 72, included in the first list
        %'VANDERM2', ...     % 72, included in the first list
        %'LAKES', ...        % 65, included in the SEGFAULT list
        %'CORE1', ...        % 64, included in the first list
        %'CVXQP1', ...       % 54, included in the first list
        %'MSS1', ...         % 39, included in the first list
        %'CHNRSNBMNE', ...   % 32, included in the first list
        %'TRO4X4', ...       % 30, included in the first list
        %'DUAL2', ...        % 30, included in the first list
         }];
