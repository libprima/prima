...
if isfield(options, 'list')
    ...
    % The following problems take too much time and make the profiling on GitHub Actions run overtime.
    if any(startsWith(solvers, 'uobyqa'))
        requirements.blacklist = [requirements.blacklist, { ...
            'ARGTRIGLS', ...
            'BA-L1LS', ...
            'BA-L1SPLS', ...
            'BROWNAL', ...
    ...
    if any(startsWith(solvers, 'cobyla'))
        ...
        requirements.blacklist = [requirements.blacklist, {'VANDERM4', 'LAKES'}];
