...
case 'cobyla'
    ...
    blacklist = [blacklist, {'VANDERM4', 'LAKES'}];
end

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Old blacklist for lincoa:
%    blacklist = [blacklist, {'TARGUS', 'ARGTRIGLS', 'VARDIM'}];  % Takes too long time
%    blacklist = [blacklist, {'AGG', 'DALLASM', 'GMNCASE1', 'GMNCASE2', 'SMBANK', 'SSEBLIN'}];  % Takes more than 10 seconds to solve; removed for quick profiling
%    %blacklist = [blacklist, {'DALLASM','GMNCASE1', 'GMNCASE2', 'SMBANK'}];  % Takes more than 10 seconds to solve; removed for quick profiling

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Old blacklist for cobyla:
%    %blacklist = [blacklist, {'CHEBYQADNE','HAIFAM','HIMMELBI','HYDCAR20','LUKSAN12','LUKSAN13','MSS1','SPANHYD','VANDERM1','VANDERM2','VANDERM3', 'TAX13322', 'TAXR13322'}]; % Takes more than 2 min to solve
%    blacklist = [blacklist, {'ACOPP30', 'ACOPR30', 'AIRPORT', 'CHANDHEQ', ...
...
%    blacklist = [blacklist, {'DMN15102', 'DMN15103', 'DMN15332', 'DMN15333', 'DMN37142', 'DMN37143'}]; % Time-consuming
%    blacklist = [blacklist, {'GMNCASE2'}];
