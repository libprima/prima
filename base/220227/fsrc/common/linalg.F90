...
! Started: July 2020
!
! Last Modified: Wednesday, March 16, 2022 PM10:38:33
!--------------------------------------------------------------------------------------------------
...
if (DEBUGGING) then
    ...
    tol = max(1.0E-8_RP, min(1.0E-1_RP, 1.0E12_RP * EPS * real(n + 1_IK, RP)))
...
elseif (abs(x(1)) <= EPS * abs(x(2))) then
    ...
    ! as SIGN(RESHAPE([ZERO, -ONE, ONE, ZERO], [2, 2]), X(2)). ! This mistake was comitted on on
