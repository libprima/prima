...
if ~isempty(requirements.list)
    ...
    case {'lincoa', 'lincoan'}
        ...
        blacklist = [blacklist, {'DUAL3', 'DUAL2', 'DUAL1','SIM2BQP', 'BQP1VAR', 'LUKSAN22LS','LUKSAN21LS','MINSURF', 'QPCBLEND'}]; % Too long to solve
    case {'cobyla', 'cobylan'}
        blacklist = [blacklist, {'PALMER4ANE', 'PALMER5BNE', 'VESUVIA', 'MESH', 'LOADBAL'}];
        ...
        blacklist = [blacklist, {'PRODPL0', 'DEGENLPB', 'ANTWERP', 'SIPOW3', 'AVION2', 'HIMMELBI', 'HS55','PRODPL1', 'BQPGASIM','LSNNODOC'}]; % Takes long to solve
