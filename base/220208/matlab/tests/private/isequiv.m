...
if isempty(requirements.list)
    ...
    case {'lincoa', 'lincoan'}
        ...
        blacklist = [blacklist, {' QPNBOEI2', 'QPCBOEI2', 'SIM2BQP', 'BQP1VAR', 'LUKSAN22LS'}]; % Too long to solve
    case {'cobyla', 'cobylan'}
        ...
        blacklist = [blacklist, {'DEGENLPB', 'LSNNODOC', 'AVION2', 'RES', 'SIPOW3', 'HS55','PRODPL1', 'BQPGASIM'}]; % Takes long to solve
