...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
     ...
     &, qfac, rfac, snorm, step, g, resnew, resact, d, dw, w)
      ...
      dimension amat(n, *), xpt(npt, *), hq(*), pq(*), iact(*), rescon(*&
     &), qfac(n, *), rfac(*), step(*), g(*), resnew(*), resact(*), d(*),&
     & dw(*), w(*)
!
...
! values. Exit when NCALL is large or NaN detected.
     ...
     & alpht /= alpht .or. alphm /= alphm .or. dgd /= dgd .or. dg /= dg &
     &.or. ss /= ss .or. snsq /= snsq .or. reduct /= reduct) then
          goto 320
      end if
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
