...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
      ...
      subroutine prelim(calfun, n, npt, m, amat, b, x, rhobeg, iprint, x&
     &base, xpt, fval, xsav, xopt, gopt, kopt, hq, pq, bmat, zmat, idz, &
     &ndim, sp, rescon, step, pqw, w, f, ftarget, A_orig, b_orig, cstrv,&
     & nf, xhist, maxxhist, fhist, maxfhist, chist, maxchist)
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
     ...
     &), hq(*), pq(*), bmat(ndim, *), zmat(npt, *), sp(*), rescon(*), st&
     &ep(*), pqw(*), w(*)
!
