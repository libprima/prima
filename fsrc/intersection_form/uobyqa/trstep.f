...
!*++
            REAL*8 :: delsq , dhd , dnorm , dsq , dtg , dtz , gam , gnor&
     &m , gsq , hnorm , one , par , parl , parlest , paru , paruest , ph&
     &i , phil , phiu , pivksv , pivot , posdef , scale , shfmax , shfmi&
     &n , shift , slope , sum , sumd , tdmin , temp , tempa , tempb , tw&
     &o , wsq , wwsq , wz , zero , zsq
            REAL*8 , DIMENSION(N) :: dsav
            INTEGER :: i , iterc , j , jp , k , kp , kpp , ksav , ksave &
     &, nm
!*++
