...
! and the NEWUOA paper.
      ...
      subroutine newuoa(calfun, x, f, nf, rhobeg, rhoend, eta1, eta2, ga&
     &mma1, gamma2, ftarget, npt, maxfun, iprint, info, xhist, fhist, ma&
     &xhist)
...
! which may not be present.
     ...
     &rget_v, gamma1_v, gamma2_v, rhobeg_v, rhoend_v, x, nf, f, fh, xh, &
     &info)
