...
!*==trsbox.f90  processed by SPAG 7.50RE at 17:55 on 25 May 2021
            SUBROUTINE TRSBOX(N,Npt,Xpt,Xopt,Gopt,Hq,Pq,Sl,Su,Delta,Xnew&
     &,D, Gnew,Xbdi,S,Hs,Hred,Dsq,Crvmin)
...
!*++
            REAL*8 :: angbd , angt , beta , blen , cth , delsq , dhd , d&
     &hs , dredg , dredsq , ds , ggsav , gredsq , half , one , onemin , &
     &qred , rdnext , rdprev , redmax , rednew , redsav , resid , sdec ,&
     & shs , sredg , ssq , stepsq , sth , stplen , temp , tempa , tempb &
     &, xsav , xsum , zero
            INTEGER :: i , iact , ih , isav , itcsav , iterc , itermax ,&
     & iu , j , k , nact
!*++
...
!
                  ...
                  IF ( stplen>zero ) THEN
                     ...
                     DO i = 1 , N
                        ...
                        IF ( Xbdi(i)==zero ) gredsq = gredsq + Gnew(i)**&
     &2
                        D(i) = D(i) + stplen*S(i)
                     ENDDO
