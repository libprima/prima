...
!*++
      real*8 :: almost_infinity, del, delsav, delta, dffalt, diff, dists&
     &q, fopt, fsave, half, one, qoptsq, ratio, rho, snorm, ssq, sum, su&
     &mz, temp, tenth, vqalt, vquad, xdiff, xoptsq, zero
