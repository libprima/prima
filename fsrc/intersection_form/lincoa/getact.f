...
!*++
            REAL*8 :: cosv , ctol , cval , dd , ddsav , dnorm , one , rd&
     &iag , sinv , sprod , sum , sval , tdel , temp , test , tiny , viol&
     &mx , vmult , zero
            INTEGER :: i , ic , idiag , iflag , j , jc , jcp , jdiag , j&
     &w , k , l , nactp
!*++
                  ...
                  DO j = N , 1 , -1
                     ...
                     ELSE
                        ...
                        DO i = 1 , N
                           ...
                           Qfac(i,j+1) = -sinv*Qfac(i,j) + cosv*Qfac(i,j&
     &+1)
                           Qfac(i,j) = temp
                        ENDDO
                     ENDIF
               ...
               IF ( jc<Nact ) THEN
                  ...
                  IF ( jcp<Nact ) THEN
                     DO j = jcp + 1 , Nact
                        ...
                        Rfac(jw+jcp) = cval*Rfac(jw+jc) - sval*Rfac(jw+j&
     &cp)
                        Rfac(jw+jc) = temp
                        jw = jw + j
                     ENDDO
