! This is the intersection-format version of trustregion.f.
...
! Calculate the new S and HS. Then test for convergence.
            ...
            function trrad(delta, dnorm, eta1, eta2, gamma1, gamma2, rat&
     &io)
...
! General module
            ...
            real(RP), intent(in) :: dnorm ! Norm of current trust region&
     &step
            real(RP), intent(in) :: eta1 ! Ratio threshold for contracti&
     &on
