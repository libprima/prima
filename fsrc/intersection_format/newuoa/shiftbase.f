! This is the intersection-format version of shiftbase.f.
...
! on 03-Aug-2020.
            ...
            subroutine shiftbase(idz, pq, zmat, bmat, gq, hq, xbase, xop&
     &t,xpt)
...
! Intermediate variables
            ...
            real(RP) :: qxoptq, xoptsq, xpq(size(xopt)), bmatk(size(bmat&
     &, 1))
