...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
      ...
      C
      C The arrays BMAT and ZMAT are updated, as required by the new pos&
     &ition
      C of the interpolation point that has the index KNEW. The vector V&
     &LAG has
      C N+NPT components, set on entry to the first NPT and last N compo&
     &nents
      C of the product Hw in equation (4.11) of the Powell (2006) paper &
     &on
      C NEWUOA. Further, BETA is set on entry to the value of the parame&
     &ter
      C with that name, and DENOM is set to the denominator of the updat&
     &ing
      C formula. Elements of ZMAT may be treated as zero if their moduli&
     &are
      C at most ZTEST. The first NDIM elements of W are used for working&
     &space.
      C
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
            ...
            END DO
      C
      C Put the first NPT components of the KNEW-th column of HLAG into &
     &W,
