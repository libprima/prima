...
!-------------------- Call NEWUOB, which performs the real calculations. --------------------------!
      call newuob(calfun, iprint_loc, maxfun_loc, npt_loc, eta1_loc, eta&
     &2_loc, ftarget_loc, gamma1_loc, gamma2_loc, rhobeg_loc, rhoend_loc&
     &, x, nf_loc, f, fhist_loc, xhist_loc, info_loc)
!--------------------------------------------------------------------------------------------------!
