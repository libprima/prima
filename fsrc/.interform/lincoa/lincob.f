...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
      ...
      subroutine lincob(calfun, n, npt, m, amat, b_in, x, rhobeg, rhoend&
     &, iprint, maxfun, xbase, xpt, fval, xsav, xopt, gopt, hq, pq, bmat&
     &, zmat, ndim, step, sp, xnew, iact, rescon, qfac, rfac, pqw, w, f,&
     & info, ftarget, A_orig, b_orig, cstrv, nf, xhist, maxxhist, fhist,&
     & maxfhist, chist, maxchist)

      use, non_intrinsic :: consts_mod, only : RP, IK, ZERO, ONE, HALF, &
     &TENTH
      use, non_intrinsic :: evaluate_mod, only : evaluate
      use, non_intrinsic :: history_mod, only : savehist, rangehist
      use, non_intrinsic :: linalg_mod, only : inprod, matprod, norm, ma&
     &ximum
...
! Local variables
      real(RP) :: b(size(b_in))
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
      dimension xbase(*), xpt(npt, *), fval(*), xsav(*), xopt(*), gopt(*&
     &), hq(*), pq(*), bmat(ndim, *), zmat(npt, *), step(*), sp(*), xnew&
     &(*), iact(*), rescon(*), qfac(n, *), rfac(*), pqw(*), w(*)
!
...
!
      call prelim(calfun, n, npt, m, amat, b, x, rhobeg, iprint, xbase, &
     &xpt, fval, xsav, xopt, gopt, kopt, hq, pq, bmat, zmat, idz, ndim, &
     &sp, rescon, step, pqw, w, f, ftarget, A_orig, b_orig, cstrv, nf, x&
     &hist, maxxhist, fhist, maxfhist, chist, maxchist)
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
