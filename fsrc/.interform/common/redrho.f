!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
! This is the intersection-form version of redrho.f90.
...
! Preconditions
      if (DEBUGGING) then
          call assert(rho_in > rhoend .and. rhoend > 0, 'RHO_IN > RHOEND&
     & > 0', srname)
      end if
...
! Postconditions
      if (DEBUGGING) then
          call assert(rho_in > rho .and. rho >= rhoend, 'RHO_IN > RHO >=&
     & RHOEND', srname)
      end if
      end function redrho
