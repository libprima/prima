...
!
! Last Modified: Saturday, June 25, 2022 PM12:42:16
!--------------------------------------------------------------------------------------------------!
...
subroutine updateq(idz, knew, kopt, bmat, d, f, fval, xnew, xpt_in, zmat, gopt, hq, pq)
!--------------------------------------------------------------------------------------------------!
...
! Update the gradient.
xpt(:, knew) = xnew
gopt = gopt + moderr * bmat(:, knew) + hess_mul(xpt(:, kopt), xpt, pqinc)  ! Needs the updated XPT.
