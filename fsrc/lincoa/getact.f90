!*==getact.f90  processed by SPAG 7.50RE at 23:18 on 25 May 2021
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
     ...
     &                  Resact, G, Dw, Vlam, W)
!CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
!      IMPLICIT REAL*8*8*8 (A-H,O-Z)
      implicit none
!*--GETACT11
!*** Start of declarations inserted by SPAG
      real * 8 Amat, cosv, ctol, cval, dd, ddsav, dnorm, Dw, G,    &
     &     one, Qfac, rdiag, Resact, Resnew, Rfac, sinv, Snorm, &
     &     sprod, sum, sval
      real * 8 tdel, temp, test, tiny, violmx, Vlam, vmult, W, zero
      integer i, Iact, ic, idiag, iflag, j, jc, jcp, jdiag,    &
     &        jw, k, l, M, N, Nact, nactp
!*** End of declarations inserted by SPAG
!      DIMENSION AMAT(N,*),B(*),IACT(*),QFAC(N,*),RFAC(*),
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
      dimension Amat(N, *), Iact(*), Qfac(N, *), Rfac(*), Resnew(*), &
     &          Resact(*), G(*), Dw(*), Vlam(*), W(*)
!
