...
!
        print 99003
99003   format(/7X, 'Output from test problem 3 (3D ellipsoid ',    &
 &              'calculation)')
        n = 3
        m = 1
        xopt(1) = 1.0 / sqrt(3.0)
...
!
        print 99005
99005   format(/7X, 'Output from test problem 5 (Intermediate ',    &
 &              'Rosenbrock)')
        n = 2
        m = 0
        xopt(1) = -1.0
...
!
        print 99006
99006   format(/7X, 'Output from test problem 6 (Equation ',        &
 &              '(9.1.15) in Fletcher)')
        n = 2
        m = 2
        xopt(1) = sqrt(0.5)
...
!
        print 99007
99007   format(/7X, 'Output from test problem 7 (Equation ',        &
 &              '(14.4.2) in Fletcher)')
        n = 3
        m = 3
        xopt(1) = 0.0
...
!
        print 99009
99009   format(/7X, 'Output from test problem 9 (Hock and ',        &
 &              'Schittkowski 100)')
        n = 7
        m = 4
        xopt(1) = 2.330499
