...
subroutine calcfc_hs100(x, f, con)
...
call assert(size(x) == 7 .and. size(con) == 4, 'SIZE(X) == 7, SIZE(CON) == 4', srname)
...
con(1) = 127.0_RP - 2.0_RP * x(1)**2 - 3.0_RP * x(2)**4 - x(3) - 4.0_RP * x(4)**2 - 5.0_RP * x(5)
con(2) = 282.0_RP - 7.0_RP * x(1) - 3.0_RP * x(2) - 10.0_RP * x(3)**2 - x(4) + x(5)
con(3) = 196.0_RP - 23.0_RP * x(1) - x(2)**2 - 6.0_RP * x(6)**2 + 8.0_RP * x(7)
con(4) = -4.0_RP * x(1)**2 - x(2)**2 + 3.0_RP * x(1) * x(2) - 2.0_RP * x(3)**2 - 5.0_RP * x(6) + 11.0_RP * x(7)
