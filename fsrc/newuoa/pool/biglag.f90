     ...
     & zmat(npt, npt-n-1), delta 
      ...
      call obiglag (n,npt,xopt,transpose(xpt),transpose(bmat),zmat,idz,npt+n,knew, delta,d,alpha,hcol,gc,gd,s,w)

      end subroutine biglag

subroutine obiglag (n,npt,xopt,xpt,bmat,zmat,idz,ndim,knew, delta,d,alpha,hcol,gc,gd,s,w)
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
