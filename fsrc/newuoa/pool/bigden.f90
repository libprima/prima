subroutine bigden (n, npt, xopt, xpt, bmat, zmat, idz, kopt, knew, d, wcheck, vlag, beta)
     ...
     & zmat(npt, npt - n - 1)
      ...
      real(kind=rp) :: s(n), wvec(npt+n, 5), prod(npt+n, 5)

      print *, 'in bigden'
      call obigden (n,npt,xopt,transpose(xpt),transpose(bmat),zmat,idz,npt+n,kopt, knew,d,wcheck,vlag,beta,s,wvec,prod)

end subroutine bigden
     

subroutine obigden (n,npt,xopt,xpt,bmat,zmat,idz,ndim,kopt, knew,d,w,vlag,beta,s,wvec,prod)
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
