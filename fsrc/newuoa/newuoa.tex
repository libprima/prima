    ...
    \begin{algorithmic}
        ...
        If~$\|x_k^{+}-x_k\|\le \theta \Delta_k$ or
          \begin{align}
              ...
              \Delta_k\}\\
              \label{eq:}
              \Int_{k+1} &= \Int_k\cup\{y_k^{+}\}\setminus\{y_k^{-}\}.
          \end{align}
          \EndIf
    \end{algorithmic}
\end{algorithm}
