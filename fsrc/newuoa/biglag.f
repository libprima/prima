      subroutine biglag (n, npt, xopt, xpt, bmat, zmat, idz, knew,      &
...
!      end do
      ...
      do k = 1, npt
          temp = dot_product(xpt(k,:), xopt)
          summation = dot_product(xpt(k, :), d)
!         temp = zero
!         sum = zero
!         do j = 1, n
