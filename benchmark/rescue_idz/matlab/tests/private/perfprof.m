...
% N.B.: If the problem has no noise, then the returned point should be the best point found by the
% solver, in terms of the objective function value or a merit function. It is not the case when
% there is noise.
