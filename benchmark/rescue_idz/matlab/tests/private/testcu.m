...
if ischstr(solver) && ~strcmp(solver, 'fmincon') && ~strcmpi(solver, 'fminunc') && ~strcmpi(solver, 'fminsearch')
    ...
    prob.options.classical = prob.options.classical || (isfield(options, 'classical') && options.classical);  % FOR TESTING !!!!!!
...
%  'NASH', ...
    ...
    blacklist = [blacklist, {'3PK', 'GOFFIN', 'HS55', 'LSNNODOC', 'MAKELA4', 'MAXLIKA', 'OET1', 'QPCBOEI2', 'QPNBOEI2', 'SIPOW3', 'SIPOW4', 'TFI2'}];
case 'cobyla'
